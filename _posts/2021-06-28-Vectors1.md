...
![Displacement Figure](/_post/Displacement3.png.002.png)
...
![Displacement Figure](/_post/Displacement3.png.004.png)
...
![Displacement Figure](/_post/Displacement.004.png)



Now from the point left off, we walk 4m's in the positive x direction

![Displacement Figure](/_post/Displacement.003.png)
...
![Displacement Figure](/_post/Displacement.005.png)

NOW, if we want to calculate a distance (the scalar) of the vectors show directly above:

![Displacement Figure](/_post/Displacement.006.png)
